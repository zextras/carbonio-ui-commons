...
describe('isLink', () => {
	...
	test('A folder with isLink = true and without a zid is recognized as a link', () => {
		const folder = generateFolder({ isLink: true });
	...
	test('A folder with a zid is not recognized as a link', () => {
